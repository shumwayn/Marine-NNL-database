...
marine_implicit <- full_join (Mar_Imp, Supr_imp)  ##all marine implicit policies

as.factor(MarinePol$STAGE2)

marine_inclusive <- full_join(marine_implicit, marine_explicit)  ### Includes marine considered explicitly and implicitly
...
#GLMs of marine specific/explicit/implicit policies
