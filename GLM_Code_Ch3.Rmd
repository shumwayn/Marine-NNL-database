...
All_Stage <- polr(Policy_Analysis$STAGE2 ~  Policy_Analysis$mam_bird +Policy_Analysis$EEZ_Protected *Policy_Analysis$OHI + log(Policy_Analysis$GDP) + 
                      Policy_Analysis$Polity2, data = Policy_Analysis, Hess = TRUE) ##DRopped Richness and NRR not significant
summary(All_Stage) 
coeftest(All_Stage)
...
#Plotting the effects _ All_Stage
```{r}
