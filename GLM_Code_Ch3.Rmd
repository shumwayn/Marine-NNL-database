...
#Ordinal Logistic regression for marine policies only
```{r}

Marine_Stage <- Policy_Analysis %>% 
  filter(marine_mech == 3| marine_mech == 2|marine_mech == 1)
  

Marine_Stage$STAGE2 = factor(Marine_Stage$STAGE2, levels = c("0", "1", "2", "3", "4") )

All_Stage2 <- polr(STAGE2 ~  mam_bird + EEZ_Protected + OHI + log(GDP) + 
...
#Compute confusion table and misclassification error - model predicts 0,1 bette
predictstage = predict(All_Stage2,Policy_Analysis)
