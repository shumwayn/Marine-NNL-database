...
Implementation_Stage <- polr(Policy_Analysis$marine_mech ~  Policy_Analysis$mam_bird + Policy_Analysis$EEZ_Protected + Policy_Analysis$OHI + log(Policy_Analysis$GDP) + 
                      Policy_Analysis$Polity2 + Policy_Analysis$Richness, data = Policy_Analysis, Hess = TRUE) ##DRopped Richness and NRR not significant
summary(Implementation_Stage) 
coeftest(Implementation_Stage)

#confidence intervals
ci_All <- confint(Implementation_Stage)
