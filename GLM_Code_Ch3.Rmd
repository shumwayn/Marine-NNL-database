...
stage_risk1 <- stage_risk2 + theme(legend.position = "none")
stage_risk <- stage_risk1 + annotate("text", x= .95, y= 0, label = "p = 2.2e-16")
stage_risk
...
stage_EEZ2 <-ggplot(Policy_Analysis, aes(x = STAGE2, y = log(EEZ_Protected))) +
  ...
  scale_x_discrete(labels = stage_names)+ 
  theme_classic() 
stage_EEZ1 <- stage_EEZ2 + theme(legend.position = "none")
...
stage_health2 <-ggplot(Policy_Analysis, aes(x = STAGE2, y = OHI)) +
  ...
  #ggtitle("Odds") +
  theme_classic()
stage_health1 <- stage_health2 + theme(legend.position = "none")
stage_health <- stage_health1 + annotate("text", x= .85, y= 100, label = "p = 0.014")
stage_health 
...
stage_gdp2 <- ggplot(Policy_Analysis, aes(x = STAGE2, y = log(GDP))) +
  ...
  #ggtitle("Odds") +
  theme_classic()
stage_gdp1 <-stage_gdp2 + theme(legend.position = "none")
...
stage_polity2 <- ggplot(Policy_Analysis, aes(x = STAGE2, y = Polity2)) +
  ...
  #ggtitle("Odds") +
  theme_classic()
stage_polity1 <-stage_polity2 + theme(legend.position = "none")
