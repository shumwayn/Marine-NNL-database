...
risk_palette=c("grey50","#33FF99", "#00CC66", "#009933")

risk1 <-ggplot(Policy_Analysis, aes(x = marine_mech, y = log(mam_bird))) +
  geom_boxplot(aes(fill = marine_mech), size = .75)+ 
  geom_jitter() +
  scale_fill_manual(values=risk_palette) + # Boxplot fill color
...
health1 <-ggplot(Policy_Analysis, aes(x = marine_mech, y = OHI)) +
  geom_boxplot(aes(fill = marine_mech), size = .75)+ 
  geom_jitter() +
  scale_fill_manual(values=risk_palette) + # Boxplot fill color
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1))+
...
wealth1 <-ggplot(Policy_Analysis, aes(x = marine_mech, y = log(GDP))) +
  geom_boxplot(aes(fill = marine_mech), size = .75)+ 
  geom_jitter() +
  scale_fill_manual(values=risk_palette) + # Boxplot fill color
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1))+
...
polity1 <- ggplot(Policy_Analysis, aes(x = marine_mech, y = Polity2)) +
  geom_boxplot(aes(fill = marine_mech), size = .75)+ 
  geom_jitter() +
  scale_fill_manual(values=risk_palette) + # Boxplot fill color
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1))+
