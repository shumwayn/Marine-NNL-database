...
#Tukey Test # ## need to check multiple post hoc tests ## Bonferonni

#TukeyHSD(aov(GDP ~ marine_mech, Var_subset)) #sign diff between countries with no policy compare to countries, no difference between policies
