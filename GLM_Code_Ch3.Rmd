...
#filter by marine explicit (this actually includes marine specific)
...
##group implicit to all explicit policies - this gives you 90 policies
ALL <- offsets_db %>% 
  filter(Implicit_Explicit == "Explicit"| Implicit_Explicit == "Implicit")


All_country <- offsets_db %>% 
 filter(Implicit_Explicit == "Explicit"| Implicit_Explicit == "Implicit")
